...
from flpert.models.glow.act_norm import ActNorm
from flpert.models.glow.coupling import Coupling
from flpert.models.glow.inv_conv import InvConv
...
class Glow(nn.Module):
    ...
    Args:
        ...
        coupling_norm (str): Normalization to be used in coupling layers ('batchnorm' or 'actnorm').
    """
    ...
    def __init__(
        ...
        self.flows = _Glow(
            in_channels=4 * in_channels,  # after image squeeze
    ...
    def _pre_process(self, x):
        ...
        ldj = (
            F.softplus(y)
            + F.softplus(-y)
            - F.softplus((1.0 - self.bounds).log() - self.bounds.log())
        )
...
class _Glow(nn.Module):
    ...
    def __init__(self, in_channels, mid_channels, num_levels, num_steps, coupling_norm):
...
class _FlowStep(nn.Module):
    def __init__(self, in_channels, mid_channels, coupling_norm):
        ...
        self.coup = Coupling(in_channels // 2, mid_channels, norm=coupling_norm)
